...
asset_optimiza_2 = Asset.create(product_id: producto_optimiza.id, name: "Colabora con tu agencia y equipo de mercadeo sobre las iniciativa a realizar. Anota comentarios y sube archivos para que todos lo vean.",      url: '/assets/gallery/large/Optimiza2.png' , url_thumb: '/assets/gallery/thumbnails/t_optimiza2.png', asset_type: 'Imagen')
asset_optimiza_3 = Asset.create(product_id: producto_optimiza.id, name: "Una vez lanzada tu campaña, visualiza el rendimiento de cada iniciativa en tiempo real.",                                                      url: '/assets/gallery/large/Optimiza3.png' , url_thumb: '/assets/gallery/thumbnails/t_optimiza3.png', asset_type: 'Imagen')
asset_optimiza_4 = Asset.create(product_id: producto_optimiza.id, name: "Una vez lanzada tu campaña, visualiza el rendimiento de cada iniciativa en tiempo real.",                                                      url: '/assets/gallery/large/Optimiza4.png' , url_thumb: '/assets/gallery/thumbnails/t_optimiza4.png', asset_type: 'Imagen')
asset_optimiza_5 = Asset.create(product_id: producto_optimiza.id, name: "Visualiza el ROI de cada iniciativa.",                                                                                                         url: '/assets/gallery/large/Optimiza5.png' , url_thumb: '/assets/gallery/thumbnails/t_optimiza5.png', asset_type: 'Imagen')
asset_optimiza_6 = Asset.create(product_id: producto_optimiza.id, name: "Amplifica tus publicaciones más exitosas en el momento justo para optimizar su rendimiento.",                                                  url: '/assets/gallery/large/Optimiza6.png' , url_thumb: '/assets/gallery/thumbnails/t_optimiza6.png', asset_type: 'Imagen')
asset_optimiza_7 = Asset.create(product_id: producto_optimiza.id, name: "Visualiza tendencias de tu audiencia, organizado por detalle demográfico, geográfico, género y más.",                                          url: '/assets/gallery/large/Optimiza7.png' , url_thumb: '/assets/gallery/thumbnails/t_optimiza7.png', asset_type: 'Imagen')
asset_optimiza_8 = Asset.create(product_id: producto_optimiza.id, name: "Con el tiempo, las publicaciones dejan de ser vistas, hasta que eventualmente mueren. Entérate cuando esto ocurra para publicar nuevamente.",  url: '/assets/gallery/large/Optimiza8.png' , url_thumb: '/assets/gallery/thumbnails/t_optimiza8.png', asset_type: 'Imagen')

asset_viraliza_1 = Asset.create(product_id: producto_viraliza.id, name: "Utiliza tecnología y bases de datos robustas para servir tu video a las personas indicadas.",                        url: '/assets/gallery/large/Viraliza1.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza1.png', asset_type: 'Imagen')
asset_viraliza_1 = Asset.create(product_id: producto_viraliza.id, name: "Visualiza como tu campaña responde y es optimizada en tiempo real.",                                                 url: '/assets/gallery/large/Viraliza2.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza2.png', asset_type: 'Imagen')
asset_viraliza_1 = Asset.create(product_id: producto_viraliza.id, name: "Para que un video cuente como “visto”, el espectador debe darle reproducir al video y verlo durante 30 segundos.",   url: '/assets/gallery/large/Viraliza3.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza3.png', asset_type: 'Imagen')
asset_viraliza_1 = Asset.create(product_id: producto_viraliza.id, name: "Colocación en móvil.",                                                                                               url: '/assets/gallery/large/Viraliza4.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza4.png', asset_type: 'Imagen')
asset_viraliza_1 = Asset.create(product_id: producto_viraliza.id, name: "Colocación en juegos.",                                                                                              url: '/assets/gallery/large/Viraliza5.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza5.png', asset_type: 'Imagen')
asset_viraliza_1 = Asset.create(product_id: producto_viraliza.id, name: "Distribución a través de influenciadores.",                                                                          url: '/assets/gallery/large/Viraliza6.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza6.png', asset_type: 'Imagen')
asset_viraliza_1 = Asset.create(product_id: producto_viraliza.id, name: "Distribución en todas las redes sociales.",                                                                          url: '/assets/gallery/large/Viraliza7.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza7.png', asset_type: 'Imagen')
