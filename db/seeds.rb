...
#assets
asset_escucha_1 = Asset.create(product_id: producto_escucha.id, name: "Escucha es un focus group en tiempo real. Conoce exactamente qué dicen las personas acerca de tu marca, las de tu competencia o una categoría dentro de tu industria.",                url: '/assets/gallery/large/Escucha1.jpg' , url_thumb: '/assets/gallery/thumbnails/t_escucha1.png', asset_type: 'Imagen')
asset_escucha_2 = Asset.create(product_id: producto_escucha.id, name: "Optimiza el manejo de tus comunidades al conocer qué contenidos funcionan mejor y cuándo publicados para máximo rendimiento.",                                                         url: '/assets/gallery/large/Escucha2.jpg' , url_thumb: '/assets/gallery/thumbnails/t_escucha2.png', asset_type: 'Imagen')
asset_escucha_3 = Asset.create(product_id: producto_escucha.id, name: "Analiza tus hashtags o campañas de mercadeo para evaluar si están llegando al mercado objetivo deseado.",                                                                              url: '/assets/gallery/large/Escucha3.jpg' , url_thumb: '/assets/gallery/thumbnails/t_escucha3.png', asset_type: 'Imagen')
asset_escucha_4 = Asset.create(product_id: producto_escucha.id, name: "Genera prospectos al participar en las conversaciones cuando alguien exprese intención de compra por tu producto / servicio o se queje de tu competencia.",                            url: '/assets/gallery/large/Escucha4.jpg' , url_thumb: '/assets/gallery/thumbnails/t_escucha4.png', asset_type: 'Imagen')
asset_escucha_5 = Asset.create(product_id: producto_escucha.id, name: "Mejora tu servicio al cliente y responde a dudas todas las redes sociales directamente desde la aplicación.",                                                                          url: '/assets/gallery/large/Escucha5.jpg' , url_thumb: '/assets/gallery/thumbnails/t_escucha5.png', asset_type: 'Imagen')
asset_escucha_6 = Asset.create(product_id: producto_escucha.id, name: "Identifica a las personas más influyentes para tu negocio y genera listas con cientos de influenciadores para tu negocio, competencia o industria.",                                   url: '/assets/gallery/large/Escucha6.jpg' , url_thumb: '/assets/gallery/thumbnails/t_escucha6.png', asset_type: 'Imagen')
asset_escucha_7 = Asset.create(product_id: producto_escucha.id, name: "Cada elemento en Escucha es cliqueable, con lo que podrás observar las conversaciones naturales que ocurren entre los consumidores y entender la motivación detrás de sus acciones.",  url: '/assets/gallery/large/Escucha7.jpg' , url_thumb: '/assets/gallery/thumbnails/t_escucha7.png', asset_type: 'Imagen')

asset_optimiza_1 = Asset.create(product_id: producto_optimiza.id, name: "Planifica tu campaña con estimaciones de CPM y CPC antes de invertir. Luego en base al costo, ajusta como quieres distribuir tu presupuesto.", url: '/assets/gallery/large/Optimiza1.jpg' , url_thumb: '/assets/gallery/thumbnails/t_optimiza1.png', asset_type: 'Imagen')
asset_optimiza_2 = Asset.create(product_id: producto_optimiza.id, name: "Colabora con tu agencia y equipo de mercadeo sobre las iniciativa a realizar. Anota comentarios y sube archivos para que todos lo vean.",      url: '/assets/gallery/large/Optimiza2.jpg' , url_thumb: '/assets/gallery/thumbnails/t_optimiza2.png', asset_type: 'Imagen')
asset_optimiza_3 = Asset.create(product_id: producto_optimiza.id, name: "Una vez lanzada tu campaña, visualiza el rendimiento de cada iniciativa en tiempo real.",                                                      url: '/assets/gallery/large/Optimiza3.jpg' , url_thumb: '/assets/gallery/thumbnails/t_optimiza3.png', asset_type: 'Imagen')
asset_optimiza_4 = Asset.create(product_id: producto_optimiza.id, name: "Una vez lanzada tu campaña, visualiza el rendimiento de cada iniciativa en tiempo real.",                                                      url: '/assets/gallery/large/Optimiza4.jpg' , url_thumb: '/assets/gallery/thumbnails/t_optimiza4.png', asset_type: 'Imagen')
asset_optimiza_5 = Asset.create(product_id: producto_optimiza.id, name: "Visualiza el ROI de cada iniciativa.",                                                                                                         url: '/assets/gallery/large/Optimiza5.jpg' , url_thumb: '/assets/gallery/thumbnails/t_optimiza5.png', asset_type: 'Imagen')
asset_optimiza_6 = Asset.create(product_id: producto_optimiza.id, name: "Amplifica tus publicaciones más exitosas en el momento justo para optimizar su rendimiento.",                                                  url: '/assets/gallery/large/Optimiza6.jpg' , url_thumb: '/assets/gallery/thumbnails/t_optimiza6.png', asset_type: 'Imagen')
asset_optimiza_7 = Asset.create(product_id: producto_optimiza.id, name: "Visualiza tendencias de tu audiencia, organizado por detalle demográfico, geográfico, género y más.",                                          url: '/assets/gallery/large/Optimiza7.jpg' , url_thumb: '/assets/gallery/thumbnails/t_optimiza7.png', asset_type: 'Imagen')
asset_optimiza_8 = Asset.create(product_id: producto_optimiza.id, name: "Con el tiempo, las publicaciones dejan de ser vistas, hasta que eventualmente mueren. Entérate cuando esto ocurra para publicar nuevamente.",  url: '/assets/gallery/large/Optimiza8.jpg' , url_thumb: '/assets/gallery/thumbnails/t_optimiza8.png', asset_type: 'Imagen')

asset_viraliza_1 = Asset.create(product_id: producto_viraliza.id, name: "Utiliza tecnología y bases de datos robustas para servir tu video a las personas indicadas.",                        url: '/assets/gallery/large/Viraliza1.jpg' , url_thumb: '/assets/gallery/thumbnails/t_viraliza1.png', asset_type: 'Imagen')
...
asset_viraliza_3 = Asset.create(product_id: producto_viraliza.id, name: "Para que un video cuente como “visto”, el espectador debe darle reproducir al video y verlo durante 30 segundos.",   url: '/assets/gallery/large/Viraliza3.jpg' , url_thumb: '/assets/gallery/thumbnails/t_viraliza3.png', asset_type: 'Imagen')
asset_viraliza_4 = Asset.create(product_id: producto_viraliza.id, name: "Colocación en móvil.",                                                                                               url: '/assets/gallery/large/Viraliza4.jpg' , url_thumb: '/assets/gallery/thumbnails/t_viraliza4.png', asset_type: 'Imagen')
asset_viraliza_5 = Asset.create(product_id: producto_viraliza.id, name: "Colocación en juegos.",                                                                                              url: '/assets/gallery/large/Viraliza5.jpg' , url_thumb: '/assets/gallery/thumbnails/t_viraliza5.png', asset_type: 'Imagen')
asset_viraliza_6 = Asset.create(product_id: producto_viraliza.id, name: "Distribución a través de influenciadores.",                                                                          url: '/assets/gallery/large/Viraliza6.jpg' , url_thumb: '/assets/gallery/thumbnails/t_viraliza6.png', asset_type: 'Imagen')
asset_viraliza_7 = Asset.create(product_id: producto_viraliza.id, name: "Distribución en todas las redes sociales.",                                                                          url: '/assets/gallery/large/Viraliza7.jpg' , url_thumb: '/assets/gallery/thumbnails/t_viraliza7.png', asset_type: 'Imagen')
