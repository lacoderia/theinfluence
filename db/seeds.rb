...
asset_viraliza_3 = Asset.create(product_id: producto_viraliza.id, name: "Para que un video cuente como “visto”, el espectador debe darle reproducir al video y verlo durante 30 segundos.",   url: '/assets/gallery/large/Viraliza3.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza3.png', asset_type: 'Imagen')
asset_viraliza_4 = Asset.create(product_id: producto_viraliza.id, name: "Colocación en móvil.",                                                                                               url: '/assets/gallery/large/Viraliza4.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza4.png', asset_type: 'Imagen')
asset_viraliza_5 = Asset.create(product_id: producto_viraliza.id, name: "Colocación en juegos.",                                                                                              url: '/assets/gallery/large/Viraliza5.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza5.png', asset_type: 'Imagen')
asset_viraliza_6 = Asset.create(product_id: producto_viraliza.id, name: "Distribución a través de influenciadores.",                                                                          url: '/assets/gallery/large/Viraliza6.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza6.png', asset_type: 'Imagen')
asset_viraliza_7 = Asset.create(product_id: producto_viraliza.id, name: "Distribución en todas las redes sociales.",                                                                          url: '/assets/gallery/large/Viraliza7.png' , url_thumb: '/assets/gallery/thumbnails/t_viraliza7.png', asset_type: 'Imagen')
